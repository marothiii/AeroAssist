...
OUTPUT_PATH = RESULTS_DIR / "speech_moderate_evaluation.csv"
...
TEST_CASES = [
    {
        "id": "SPEECH001M",
        "filename": "speech_01_moderate.m4a",
    ...
    {
        "id": "SPEECH002M",
        "filename": "speech_02_moderate.m4a",
    ...
    {
        "id": "SPEECH003M",
        "filename": "speech_03_moderate.m4a",
    ...
    {
        "id": "SPEECH004M",
        "filename": "speech_04_moderate.m4a",
    ...
    {
        "id": "SPEECH005M",
        "filename": "speech_05_moderate.m4a",
...
def main():
    ...
    print("\nEvaluating moderate-noise speech...\n")
    ...
    for case in TEST_CASES:
        ...
        row = {
            ...
            "retrieved_record": text_result["record"]["id"],
        }
    ...
    print("\nModerate-Noise Speech Evaluation")
    print("================================")

    print(f"Samples: {len(results)}")
    print(f"Mean WER: {mean_wer:.3f}")
    print(f"Intent accuracy: {intent_accuracy:.3f}")
    print(f"Downstream accuracy: {downstream_accuracy:.3f}")
